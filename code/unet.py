...
class ContrLayer:
    ...
    def __init__(self, input_layer, factor, activ_func, kernel_initializer, dropout_rate):
        self.conv1 = Conv2D(filters=64*factor, kernel_size=(3, 3), activation=activ_func,
                            padding="same", kernel_initializer=kernel_initializer)(input_layer)
        self.conv2 = Conv2D(filters=64*factor, kernel_size=(3, 3), activation=activ_func,
...
class ExpLayer:
    ...
    def __init__(self, input_layer, concat_layer, factor, activ_func, kernel_initializer, dropout_rate):
        ...
        self.deconv1 = Conv2DTranspose(filters=64*factor, kernel_size=(3, 3), strides=(
        ...
        self.output = Conv2D(filters=64*factor, kernel_size=(3, 3), activation=activ_func,
                             padding="same", kernel_initializer=kernel_initializer)(self.conv1)
...
def unet(input_size):
    ...
    # bottom layer
    layer5_1 = Conv2D(filters=64*8, kernel_size=(3, 3), activation="relu",
                      padding="same", kernel_initializer="he_normal")(layer4.output)
    layer5_2 = Conv2D(filters=64*8, kernel_size=(3, 3), activation="relu",
    ...
    output_layer = Conv2D(filters=1, kernel_size=(
